...
Argument layer built on the Toulmin model of argumentation and standard informal-logic fallacy categories, both public-domain analytical frameworks, not sourced from any single repo. No source file is reproduced verbatim; all rules are restated and reorganized into the MECE structure above.
